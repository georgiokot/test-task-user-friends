# Как запустить
для работы необходима версия php не ниже 7.1.3


    composer install 

Отредактировать файл ".env" в корне проекта, указав настройки к базе данных 

    DATABASE_URL=mysql://db_user:db_password@127.0.0.1:3306/db_name 
        
    
В консоле из корня проекта  запустить команду постороения рекомендаций 

    php bin/console App:RecommendFriends
